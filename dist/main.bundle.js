...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__components_widget_widget_heading_widget_heading_component__ = __webpack_require__("../../../../../src/app/components/widget/widget-heading/widget-heading.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__components_widget_widget_new_widget_new_header_widget_new_header_component__ = __webpack_require__("../../../../../src/app/components/widget/widget-new/widget-new-header/widget-new-header.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__components_widget_widget_new_widget_new_image_widget_new_image_component__ = __webpack_require__("../../../../../src/app/components/widget/widget-new/widget-new-image/widget-new-image.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__components_widget_widget_new_widget_new_youtube_widget_new_youtube_component__ = __webpack_require__("../../../../../src/app/components/widget/widget-new/widget-new-youtube/widget-new-youtube.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__components_widget_widget_edit_widget_edit_header_widget_edit_header_component__ = __webpack_require__("../../../../../src/app/components/widget/widget-edit/widget-edit-header/widget-edit-header.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__components_widget_widget_edit_widget_edit_image_widget_edit_image_component__ = __webpack_require__("../../../../../src/app/components/widget/widget-edit/widget-edit-image/widget-edit-image.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30__components_widget_widget_edit_widget_edit_youtube_widget_edit_youtube_component__ = __webpack_require__("../../../../../src/app/components/widget/widget-edit/widget-edit-youtube/widget-edit-youtube.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_31__components_widget_widget_image_widget_image_component__ = __webpack_require__("../../../../../src/app/components/widget/widget-image/widget-image.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["M" /* NgModule */])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_31__components_widget_widget_image_widget_image_component__["a" /* WidgetImageComponent */],
            __WEBPACK_IMPORTED_MODULE_15__components_widget_widget_youtube_widget_youtube_component__["a" /* WidgetYoutubeComponent */],
            __WEBPACK_IMPORTED_MODULE_24__components_widget_widget_heading_widget_heading_component__["a" /* WidgetHeadingComponent */],
            __WEBPACK_IMPORTED_MODULE_25__components_widget_widget_new_widget_new_header_widget_new_header_component__["a" /* WidgetNewHeaderComponent */],
            __WEBPACK_IMPORTED_MODULE_26__components_widget_widget_new_widget_new_image_widget_new_image_component__["a" /* WidgetNewImageComponent */],
            __WEBPACK_IMPORTED_MODULE_27__components_widget_widget_new_widget_new_youtube_widget_new_youtube_component__["a" /* WidgetNewYoutubeComponent */],
            __WEBPACK_IMPORTED_MODULE_28__components_widget_widget_edit_widget_edit_header_widget_edit_header_component__["a" /* WidgetEditHeaderComponent */],
            __WEBPACK_IMPORTED_MODULE_29__components_widget_widget_edit_widget_edit_image_widget_edit_image_component__["a" /* WidgetEditImageComponent */],
            __WEBPACK_IMPORTED_MODULE_30__components_widget_widget_edit_widget_edit_youtube_widget_edit_youtube_component__["a" /* WidgetEditYoutubeComponent */]
        ],
        imports: [
...
var PageNewComponent = (function () {
    ...
    PageNewComponent.prototype.createPage = function (pagename, pagetitle) {
        var _this = this;
        var page = { '_id': '321', 'name': pagename, 'websiteId': this.websiteId, 'description': 'new' };
        ...
        if (username.length === 0 || password.length === 0 || verifypassword.length === 0) {
            ...
            this.userService.findUserByCredentials(username, password)
                ...
                if (user) {
                    ...
                    var newUser = new __WEBPACK_IMPORTED_MODULE_1__models_user_model_client__["a" /* User */]('', username, password);
...
var WebsiteNewComponent = (function () {
    ...
    WebsiteNewComponent.prototype.createWebsite = function (websitename, websitedescription) {
        var _this = this;
        var website = new __WEBPACK_IMPORTED_MODULE_3__models_website_model_client__["a" /* Website */]('', websitename, this.userId, websitedescription);
...
var WidgetNewHeaderComponent = (function () {
    ...
    WidgetNewHeaderComponent.prototype.createHeader = function (name, text, size) {
        var _this = this;
        var widget = { '_id': '', 'type': 1, 'size': size, 'text': text, 'src': '', pageId: this.pageId };
        this.widgetService.createWidget(this.pageId, widget)
            .subscribe(function (pages) {
...
var WidgetNewImageComponent = (function () {
    function WidgetNewImageComponent(widgetService, activatedRoute, router) {
        this.widgetService = widgetService;
        this.activatedRoute = activatedRoute;
        this.router = router;
    }
    WidgetNewImageComponent.prototype.createImage = function (name, text, url, width) {
        var _this = this;
        var widget = { '_id': '', 'type': 2, 'size': '', 'text': text, 'src': url, pageId: this.pageId };
        this.widgetService.createWidget(this.pageId, widget)
            .subscribe(function (pages) {
            _this.router.navigate(['profile', _this.userId, 'website', _this.websiteId, 'page', _this.pageId, 'widget']);
        });
...
var Widget = (function () {
    function Widget(id, type, size, text, src) {
        this._id = id;
        this.type = type;
        this.size = size;
        this.text = text;
...
var WebsiteService = (function () {
    ...
    WebsiteService.prototype.updateWebsite = function (userId, newWebsite) {
        var url = 'http://localhost:3100/api/user/' + userId + '/website/' + newWebsite._id;
